...
if __name__=="__main__":
    ...
    X_train,y_train = dataset.dataset.get_balanced_dataset(train[0],train[1])
    ...
    predict_x=oversample_model.predict(test[0]) 
    oversample_fraud_predictions=np.argmax(predict_x,axis=1)

    oversample_smote = confusion_matrix(test[1], oversample_fraud_predictions)
